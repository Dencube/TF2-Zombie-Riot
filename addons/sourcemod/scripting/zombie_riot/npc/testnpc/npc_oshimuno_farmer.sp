...
{
	return OshimunoFarmer(vecPos, vecAng, team);
}
...
methodmap OshimunoFarmer < CClotBody
{
	...
	public OshimunoFarmer(float vecPos[3], float vecAng[3], int ally)
	{
		OshimunoFarmer npc = view_as<OshimunoFarmer>(CClotBody(vecPos, vecAng, "models/player/engineer.mdl", "1.35", "15000", ally));
