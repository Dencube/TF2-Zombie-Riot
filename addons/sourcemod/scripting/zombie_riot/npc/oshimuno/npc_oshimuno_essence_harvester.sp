...
static void ClotThink(int iNPC)
{
	...
	if(target > 0)
	{
		...
		{
			switch(OshimunoEssenceHarvesterSelfDefense(npc, gameTime, npc.m_iTarget, distance))
			{
				case 0:
				{
...
static int OshimunoEssenceHarvesterSelfDefense(OshimunoEssenceHarvester npc, float gameTime, int target, float distance)
{
