...
static void ClotThink(int iNPC)
{
	...
	if(IsValidEnemy(npc.index, npc.m_iTarget))
	{
		...
		int ActionDo = OshimunoBartenderSelfDefense(npc,GetGameTime(npc.index), distance); 
		switch(ActionDo)
		{
			case 0:
			{
...
static int OshimunoBartenderSelfDefense(OshimunoBartender npc, float gameTime, float distance)
{
	//Direct mode
